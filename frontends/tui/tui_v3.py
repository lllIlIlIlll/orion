...
_TIPS = {
    'en': [
        ...
        "Tip: /conductor <task> hands the task to frontends/conductor/conductor.py for multi-subagent orchestration.",
    ...
    'zh': [
        ...
        "Tip: /conductor <任务> 直接交给 frontends/conductor/conductor.py 做多 subagent 编排。",
...
_I18N: dict[str, dict[str, str]] = {
    'en': {
        ...
        'cmd.conductor.desc':   'hand task to frontends/conductor/conductor.py for multi-subagent orchestration',
    ...
    'zh': {
        ...
        'cmd.conductor.desc':   '调用 frontends/conductor/conductor.py 做多 subagent 编排',
