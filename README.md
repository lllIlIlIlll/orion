...
TAU also supports IM frontends such as Telegram, Discord, and Lark.
...
- **2026-05-15** — 🖥️ **Desktop GUI released**. One-line installs ship a ready-to-run desktop app (`frontends/TAU.exe`). Developers launch via `python launch.pyw`.
...
- **2026-05-15** — 🖥️ **桌面 GUI 发布**。一键安装会自带可直接运行的桌面端（`frontends/TAU.exe`），开发者也可用 `python launch.pyw` 启动。
